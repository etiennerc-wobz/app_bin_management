...
const TrapListElement = ({trap, onUpdateTrap}) => {
    ...
    return (
        <div
            className="p-4 border-b border-gray-200 bg-gray-200 rounded-[2rem] mx-auto flex flex-row items-center justify-between">
            <div className="flex flex-row items-center">
                ...
                <div className="flex flex-col items-center pl-4 sm:pl-10 pr-8">
                    ...
                    <div className="mt-2">
                        <Tooltip title={currentMode === "open" ? "Fermer le graal" : "Ouvrir le graal"}
                                 placement="bottom">
                            <Button
                                variant="contained"
                                size="small"
