...
export default function ChangeFestivalMenu({ festival, festivals, onChangeFestival }) {
  ...
  return (
    <>
      <Button
        ...
        sx={{ borderRadius: 10, height:40, color: 'white', backgroundColor: 'rgb(0, 0,0,0)', '&:hover': { backgroundColor: alpha('#74BDB6', 0.8) } }}
      >
      </Button>
      <StyledMenu
